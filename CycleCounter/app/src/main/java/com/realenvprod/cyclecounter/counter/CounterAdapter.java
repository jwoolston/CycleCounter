...
public class CounterAdapter extends RecyclerView.Adapter<CounterAdapter.ViewHolder> {
    ...
    private final List<Counter>                     sensors;
    private final OnListFragmentInteractionListener listener;

    public CounterAdapter(List<Counter> items, OnListFragmentInteractionListener listener) {
        sensors = items;
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        holder.mItem = sensors.get(position);
        holder.mIdView.setText(sensors.get(position).id);
        holder.mContentView.setText(sensors.get(position).content);
